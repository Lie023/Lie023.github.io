...
$sql = "SELECT * FROM files WHERE course = 'Bachelor of Technical Vocational Teacher Education'";
...
<header class="">
      <div class="navbar-expand-lg container-fluid p-2 fixed-top" style="background-color:red;">
        ...
        <section class="container-fluid mt-3" id="">
            <br>
            <br>
            <h3 class="text-center my-4">Bachelor of Technical Vocational Teacher Education</h3>

           <a href="thesis.php" class="btn btn-primary my-2" style="margin-left:94%;">Back</a>
            <?php if($row>0){ ?>
