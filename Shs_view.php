...
$sql = "SELECT * FROM sh_record WHERE id = '$id'";
...
<div class="divider mb-4"></div>
  ...
  <path d="M2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2ZM1 4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H8.96c.026-.163.04-.33.04-.5C9 10.567 7.21 9 5 9c-2.086 0-3.8 1.398-3.984 3.181A1.006 1.006 0 0 1 1 12V4Z"/>
    ...
    <div class="text-end"><a id="back" href="Shs_record.php">Go Back</a></div>
                </div>
                <div class="card-body">
                    ...
                    <div class="my-4"></div>
                        ...
                        <div class="col-12">
                            <label class="lead" for="">Strand:</label>
                            <br>
                            <label class="lead mb-3 fw-bold" for=""><?php echo $row["strand"] ?></label>
                        </div>

                        <div class="col-12">
                            <label class="lead" for="">Graduate Status:</label>
                            <br>
                            <label class="lead mb-3 fw-bold" for=""><?php echo $row["graduate_status"] ?></label>
                        </div>
