...
$sql = "SELECT * FROM files WHERE course = 'Bachelor of Science in Business Administration Major in Financial Management'";
...
<header class="">
      <div class="navbar-expand-lg container-fluid p-2 fixed-top" style="background-color:red;">
        ...
        <section class="container-fluid mt-3" id="">
            <br>
            <br>
            <h3 class="text-center my-4">BSBA Major in Financial Management</h3>
